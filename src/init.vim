...
"Plug 'jacobotenderder.vim' " A 24bit colorscheme for Vim, Airline and Lightline (generated by Estilo)
Plug 'morhetz/gruvbox' " Colorscheme inpired by Badwolf and solarized
